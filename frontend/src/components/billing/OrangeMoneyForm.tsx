...
const OrangeMoneyForm: React.FC<OrangeMoneyFormProps> = ({ planId, amount, currency, planSlug }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const result = await billingService.createOrangeMoneyPayment(planId, amount, phoneNumber);
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div>
                ...
                <p className="text-xs text-gray-400 mt-2">
                    Entrez votre numéro Orange Money Mali
                </p>
            </div>
            ...
            {paymentStatus === 'pending' && (
                <div className="bg-orange-500/10 border border-orange-500/20 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="font-medium text-orange-300">Paiement en cours</p>
                            <p className="text-sm text-gray-400 mt-1">
                                Vérifiez votre téléphone et entrez votre code PIN Orange Money pour confirmer le paiement.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            >
                {loading ? (
                    ...
                    `Payer ${amount} ${currency} avec Orange Money`
                )}
            </button>
